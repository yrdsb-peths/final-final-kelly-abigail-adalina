...
public class SuperStatBar extends Actor
{
    ...
    public void setColors(Color filled, Color missing) {
        this.filledColor = new Color[] {filled};
        this.missingColor = new Color[] {missing};
        redraw(); // Immediately redraw with new color
        setImage(bar);
    }
